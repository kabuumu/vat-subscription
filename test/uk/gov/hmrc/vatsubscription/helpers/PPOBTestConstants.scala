...
object PPOBTestConstants {
  ...
  val ppobPostNoAgentEmailExample = PPOBPost(
    ppobAddressPostValue,
    Some(contactDetailsModelMax),
    Some(website),
    None
  ...
  val ppobPostExampleReadsJson: JsValue = Json.obj(
  ...
  val ppobPostExampleReadsNoAgentEmailJson: JsValue = Json.obj(
    "address" -> ppobAddressPostJson,
    "contactDetails" -> Json.toJson(contactDetailsModelMax),
    "websiteAddress" -> website
  )

  val ppobPostExampleWritesJson: JsValue = Json.obj(
    "PPOBAddress" -> ppobAddressPostJson,
    "PPOBCommDetails" -> Json.toJson(contactDetailsModelMax),
    "websiteAddress" -> website
  )
}
